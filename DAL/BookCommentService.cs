...
namespace BookShop.DAL
{
    public class BookCommentService
    {
        ...
        /// 根据书的编号找出该书下的所有的评论
        /// </summary>
        public DataSet GetList( int bookId)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select Id,Msg,CreateDateTime,BookId ");
            strSql.Append(" FROM BookComment  where BookId=@BookId");

            return DbHelperSQL.Query(strSql.ToString(), new SqlParameter("@BookId",bookId));
        }
