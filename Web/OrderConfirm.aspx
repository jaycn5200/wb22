<%@ Page Title="" Language="C#" MasterPageFile="~/BuyMaster.Master" AutoEventWireup="true" CodeBehind="OrderConfirm.aspx.cs" Inherits="BookShop.Web.OrderConfirm" %>
           ...
           <div align="left"><!--订单确定-->
            ...
            <table datasrc="" cellspacing="0" cellpadding="1" width="98%" border="1">
              <tbody>
               ...
               <h2>
                   你需要支付的总价格为:<span class="price">￥<%=totleMoney.ToString("0.00")%></span></h2><br />               
