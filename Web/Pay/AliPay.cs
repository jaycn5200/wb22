...
namespace BookShop.Web.Pay
{
    public class AliPay
    {
        ...
        public AliPay(string subject, string body, string out_trade_no, decimal total_fee)
        {
            ...
            this.sign = Common.WebCommon.CreateMd5String(total_fee + partner + out_trade_no + subject + key).ToLower();//按照文档的要求定义好数字签名。
